      ...
      <div className="flex flex-col items-center">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 20px rgba(139, 92, 246, 0.2), inset 0 0 20px rgba(139, 92, 246, 0.05), 0 10px 40px rgba(0, 0, 0, 0.3)',
      ...
      {selectedModel && (
        ...
        >
          ...
          >
            ...
            >
              {selectedModel === 'ChatGPT' ? '⚡' : selectedModel === 'Claude' ? '🤖' : selectedModel === 'Llama 3' ? '🦙' : 'G'}
            </div>
          </div>
      ...
      {selectedMemory && (
        ...
        >
          ...
          >
            ...
            >
              {selectedMemory === 'MongoDB' ? '🍃' : selectedMemory === 'Redis' ? '⚡' : selectedMemory === 'PostgreSQL' ? '🐘' : '∅'}
            </div>
          </div>
      ...
      {selectedTool && (
        ...
        >
          ...
          >
            ...
            >
              {selectedTool === 'Code Interpreter' ? '💻' : selectedTool === 'Web Search' ? '🔍' : selectedTool === 'Image Generator' ? '🎨' : '🔧'}
            </div>
          </div>
