        ...
        >
          ...
          {/* Right Side - Connection Point and Plus Button */}
            ...
            {/* Gray Circle - Always visible */}
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 15px rgba(156, 163, 175, 0.5), 0 2px 8px rgba(0, 0, 0, 0.3)',
                }}
              />
            ...
            {!hasChildren && (
              ...
              {/* Plus Button */}
              <button
                className="flex items-center justify-center rounded-lg transition-all hover:bg-gray-700"
                style={{
                  width: '32px',
                  height: '32px',
              ...
              >
                <svg className="w-5 h-5" fill="none" stroke="rgba(156, 163, 175, 0.9)" viewBox="0 0 24 24" strokeWidth={2.5}>
